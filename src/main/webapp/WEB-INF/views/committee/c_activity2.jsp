...
<script type="text/javascript">
	$(function() {
		...
		$(".a_mater").change(function(){
			if($(".a_mater").is(':checked')){
				$("#t1").attr("readonly",false);//readonly="readonly"
			}else{
				$("#t1").attr("readonly",true);
			}
		})
		...
		$.ajax({
			...
			success : function(data) {
				...
				$("#unit").empty();
		          ...
		          .attr("value",data1[key].id)//只需要把id传到后台即可
...
<body>
	<div class="col-md-12">
		...
		<form class="form-horizontal"
			action="${pageContext.request.contextPath}/committee/activity/addActivity"
			...
			<div class="col-md-12">
				...
				<div class="table_count">
					<table class="table table-bordered table-hover">
						<tr>
							...
							<td class="table1"><label>校团委名称：</label></td>
							<td class="table2"><input type="text"
								class="form-control" name="student" id="student" value="${users.username}" readonly="true" >
						...
						<tr>
							...
							<td class="table2"><input type="text"
								class="form-control" name="a_content" id="a_content" placeholder="活动内容">
							<td class="table1"><label>活动地点：</label></td>
							<td class="table2"><input type="text"
								class="form-control" name="a_place" id="a_place" placeholder="活动地点">
						</tr>
						<tr>
							<td class="table1"><label>活动负责人：</label></td>
							<td class="table2">
								<input type="text" class="form-control" name="a_person" id="a_person" placeholder="活动负责人">
							<td class="table1"><label>负责人联系方式：</label></td>
							<td class="table2">
								<input type="text" class="form-control" name="a_phone" id="a_phone" placeholder="赋值人联系方式">
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="table2"><input type="text"
								class="form-control" name="a_person_number" id="a_person_number" placeholder="活动参与人数">
						</tr>
					</table>
				</div>
					...
					<table class="table table-bordered table-hover">
						...
						<tbody>
							<tr>
								...
								<td width="20%">
									<div class="col-md-2">
										<input type="text"  width="100%" name="w_t1" id="w_t1" value="0">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td width="20%">
									<div class="col-md-2">
										<input type="text" width="100%" name="w_t2" id="w_t2" value="0">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td width="20%">
									<div class="col-md-2">
										<input type="text" width="100%" name="w_t3" id="w_t3" value="0">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td width="20%">
									<div class="col-md-2">
										<input type="text" width="100%" name="w_t4" id="w_t4" value="0">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td width="20%">
									<div class="col-md-2">
										<input type="text" width="100%" name="w_t5" id="w_t5" value="0">
									</div>
								</td>
							</tr>
						</tbody>
				...
				<div class="publicity">
					<label>活动宣传物品：</label> 
						<label> <input type="checkbox" id="box1" name="a_propa" value="1"> 喷绘 </label> 
						<label> <input type="checkbox" id="box2" name="a_propa" value="2"> 海报 </label> 
						<label> <input type="checkbox" id="box3" name="a_propa" value="3"> 展板 </label> 
						<label> <input type="checkbox" id="box4" name="a_propa" value="4"> 条幅 </label>
						<label> <input type="checkbox" id="box5" name="a_propa" value="5"> 拱门 </label>
				</div>
				...
				<div class="checkbox">
					<label> <input type="checkbox" id="box6" name="a_propa" value="6"> 活动是否涉及售卖物品  </label> 
					<label> <input type="checkbox" id="box7" name="a_propa" value="7"> 活动是否用电 </label>
					<label> <input type="checkbox" id="box8" name="a_propa" value="8"> 活动是否有校外单位参与  </label>
				</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">学生活动须知</h4>
					</div>
