...
<div class="container-fluid">
	<div class="navbar-header">
		...
		<a class="navbar-brand"
			href="${pageContext.request.contextPath}/student/activity/a.list"><strong>学生活动</strong></a>
	</div>
	...
	<div class="collapse navbar-collapse"
		...
		<ul class="nav navbar-nav" id="bar_menu">
			<li><a
				href="${pageContext.request.contextPath}/student/activity/activity"><strong>活动申报</strong></a></li>
			<li><a
				href="${pageContext.request.contextPath}/student/activity/n.list"><strong>活动公告</strong></a></li>
